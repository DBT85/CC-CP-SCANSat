...
It's currently got 12 missions for Kerbin, Mun, Minmus, Duna, Ike, Eve, Gilly, Moho, Dres, Jool's Moons and Eeloo included. Only LoRes Altimetry and Biom scans are included at this time.

All missions are now locked and balanced! Hurrah!

Version log
0.6.0 - Updated for 1.0.5 and beyond, added Eve and Duna contract for Biome data, balanced all contracts rewards, lots of tweaks! 
...
4) The Eve Mission requires that 35% LoRes data is gathered from Minmus. It has an optional part to scan Gilly.
5) The Duna mission requires that 60% LoRes data is gathered from Minmus. It has an optional part to scan Ike.
6) The second Kerbin mission requires that the second SCANSat part be unlocked and 95% of Kerbin LoRes data is gathered. Optional mission to de-orbit mission 1.
7a) The Mun & Minmus mission requires that 50% Biome data has been collected on Kerbin and 95% of LoRes Data. Optional parts to de-orbit missions 2 and 3.
7b) The Eve & Duna mission requires that 35% of Biome data has been collected on Mun & Minmus. Optional part to de-orbit missions 4 and 5.
...
10) The Joolian mission requires that 90% of Mun and Minmus have Biome data. Comprises 3 ships and 2 optional ships to scan Bop and Pol.
